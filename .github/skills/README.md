...
| Agent-Code | conventional-commit, validate-accessibility, clean-architecture-rules, accessibility-output, git-execution |
...
| Agent-FrameworkDocs | accessibility-output |
