...
Migrated from: src/infrastructure/audio/screen_reader.py (SHA: 48006281)
Zero functional changes - exact copy with updated import paths.
"""

from typing import Protocol
from src.domain.models.card import Card
from src.infrastructure.accessibility.tts_provider import TtsProvider
