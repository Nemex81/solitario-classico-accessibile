...
- [ ] **1.1** - `acs_wx.py`: Log panel transitions in `start_gameplay()`, `return_to_menu()`
- [ ] **1.2** - `acs_wx.py`: Log panel hiding in `_safe_abandon_to_menu()`, `_safe_timeout_to_menu()`, `_safe_return_to_main_menu()`
